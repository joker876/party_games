...
execute as @a[scores={game=1},tag=in_game,tag=!spectating,tag=!winner] at @s run function spleef:give_snowball
...
execute as @a[tag=in_game,tag=!spectating,scores={game=1,ypos=..-10}] at @s run function spleef:eliminate
